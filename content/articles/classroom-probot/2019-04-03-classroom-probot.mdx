---
path: '/classroom-probot'
date: '2019-04-03'
title: 'Powering up GitHub Classroom with Probot'
subtitle: 'Automate low-hanging feedback and default settings'
---
...
To handle this we can write a small Probot app to listen for repository imports[^1] and set the desired branch protection rules for the new repo. I suggest going through their [Getting Started documentation]() if you haven't already.
...
<CodeEmbed service="glitch" name="classroom-master-lockdown" />

This example hard-codes in our configuration, but it is also common to include config files inside the repo or organization itself to allow more user-level configurability.
